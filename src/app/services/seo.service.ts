...
export class SeoService {
  ...
  setTitleAndMeta(metaTags: { title: string, description: string, ogType: string, ogImage: string, twitterCard: string }) {
    this.title.setTitle(metaTags.title ? metaTags.title : this.notFoundMetas.title);
    this.meta.addTags([
      { name: 'description', content: metaTags.description ? metaTags.title : this.notFoundMetas.description },
      { property: 'og:title', content: metaTags.title ? metaTags.title : this.notFoundMetas.title },
      { property: 'og:description', content: metaTags.description ? metaTags.title : this.notFoundMetas.description },
