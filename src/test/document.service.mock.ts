export class MockDocumentService {
  ...
  createEvent = jasmine
    ...
    .and.returnValue(new Event('test'));
  ...
  importNode = jasmine
    .createSpy('importNode')
    .and.callFake((node: Node) => node);
  elementFromPoint = jasmine
    .createSpy('elementFromPoint')
    .and.returnValue(null);
  caretPositionFromPoint = jasmine
    .createSpy('caretPositionFromPoint')
    .and.returnValue(null);
  createNodeIterator = jasmine
    .createSpy('createNodeIterator')
    .and.returnValue({} as NodeIterator);
  createTreeWalker = jasmine
    .createSpy('createTreeWalker')
    .and.returnValue({} as TreeWalker);
}
